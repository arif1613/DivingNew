...
{
	[TestClass]
	public class when_getting_questions_by_chapter_name : TestSetup
	{
		[TestMethod]
		public void Getting_question_by_given_chapter()
		{
			//Arrange
			...
			var result = questionModule.GetQuestionModelsByChaptername("ch1");
			...
			Assert.AreEqual(result.Count, 1, "Result contains correct question quantity");
